...
class Twofish : public Socket::Operator {
public:
        Twofish(unsigned int seed);
        void in(QByteArray& data);
        void out(QByteArray& data);
protected:
        void initializeCipherTable();
        void initializeXORData();
private:
        unsigned short mRecvPos;
        unsigned char mSendPos;
        Twofish2::keyInstance mKey;
        Twofish2::cipherInstance mCipher;
        char mCipherTable[256];
        char mXORData[16];
};
